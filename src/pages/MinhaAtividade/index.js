...
Alert.alert(JSON.stringify(item))
    ...
    <Card style={styles.card}  >
        ...
        <View style={{flexDirection:'row', flex:1, alignItems: 'center', alignSelf:'flex-end' }}>
          ...
          <TouchableOpacity onPress={()=> this.props.navigation.navigate('Etapa',{atividade: item})} style={{marginTop:15, height:45, width:150, padding:5, alignItems:'center', marginRight:10, backgroundColor:'#FD5979',borderColor:'#00BFFF', borderRadius:10}}>
            <Text style={{color:'#fff', margin:5, fontWeight:'bold'}} >Selecionar</Text>
          </TouchableOpacity>
            )}            
          </View>
          
          {item.etapa_total===0?(<Text style={{fontWeight:'700',fontStyle:'italic', color:'green'}}>0.00%</Text>) :
...
<Text style={{color:'#fff', fontWeight:'bold', fontSize:18, margin:10}} >Minhas atividades</Text>
