...
export default class AtribuiProjeto extends Component {
...
Alert.alert(JSON.stringify(item))
    ...
    <Card style={styles.card}  >
        ...
        <View style={{flexDirection:'row', flex:1, alignItems: 'center', alignSelf:'flex-end' }}>
          ...
          <TouchableOpacity onPress={()=> this.props.navigation.navigate('AtribuiUsu',item)} style={{marginTop:15, height:45, width:150, padding:5, alignItems:'center', marginRight:10, backgroundColor:'#FD5979',borderColor:'#00BFFF', borderRadius:10}}>
            <Text style={{color:'#fff', margin:5, fontWeight:'bold'}} >Atribuir usuário</Text>
          </TouchableOpacity>
            )}
          </View>
...
<View style={{backgroundColor:'#00BFFF', alignItems:'center'}} >
